// AddDoctor.jsx (Final Corrected Version)
...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      formData.append('fees', fees) // Sent as a string, server will convert to number
  ...
  formData,
  {
    headers: {
      ...
      // Show the error message sent from the server (e.g., "Doctor already exists")
      const errorMessage = error.response?.data?.message || 'Request failed. Check server logs.';
